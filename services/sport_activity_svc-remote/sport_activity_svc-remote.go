...
func main() {
	...
	client := services.NewSportActivitySvcClientFactory(trans, protocolFactory)
	...
	case "createActivity":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "CreateActivity requires 2 args")
			flag.Usage()
		}
		...
		value1 := argvalue1
		fmt.Print(client.CreateActivity(value0, value1))
		fmt.Print("\n")
		break
	case "getAvailableActivityList":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "GetAvailableActivityList requires 1 args")
			flag.Usage()
		}
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.GetAvailableActivityList(value0))
		fmt.Print("\n")
		break
	case "getActivity":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "GetActivity requires 2 args")
			flag.Usage()
		}
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
