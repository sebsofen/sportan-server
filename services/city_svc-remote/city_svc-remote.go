...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  void createCity(string title,  coords)")
...
func main() {
	...
	case "createCity":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "CreateCity requires 2 args")
			flag.Usage()
		}
		...
		containerStruct1 := services.NewCitySvcCreateCityArgs()
		err56 := containerStruct1.ReadField2(jsProt55)
		if err56 != nil {
			Usage()
			return
		}
		argvalue1 := containerStruct1.Coords
		value1 := argvalue1
		fmt.Print(client.CreateCity(value0, value1))
		fmt.Print("\n")
		break
	case "getNearBy":
		if flag.NArg()-1 != 2 {
